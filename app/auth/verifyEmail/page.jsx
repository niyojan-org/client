...
import { IconCircleCheck, IconCircleX, IconLoader2, IconMail, IconAlertTriangle, IconArrowRight } from "@tabler/icons-react";
          ...
          <div className="flex justify-center mb-2">
            {verified ? (
              <div className="relative">
                ...
                <IconCircleCheck className="relative w-20 h-20 text-green-500" />
              </div>
            ) : (
              <div className="relative">
                <div className="absolute inset-0 bg-red-400 rounded-full blur-xl opacity-50 animate-pulse" />
                <IconCircleX className="relative w-20 h-20 text-red-500" />
              </div>
            )}
          </div>
            ...
            <div className="bg-secondary/30 rounded-lg p-6 space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  <IconArrowRight className="w-4 h-4 mt-0.5 flex-shrink-0 text-primary" />
    ...
    <Suspense
      fallback={
        <div className="min-h-screen flex justify-center items-center">
          <IconLoader2 className="animate-spin w-12 h-12 text-blue-500" />
        </div>
      }
    >
      <VerifyEmailContent />
