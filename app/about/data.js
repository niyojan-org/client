...
export const platformFeatures = [
  {
    ...
    fullContent: {
      overview: 'orgatick handles every step of your event lifecycle, from planning to post-event analysis.',
      keyFeatures: [
...
export const contactInfo = [
  { icon: IconMail, title: 'Email Us', info: 'support@orgatick.in', bg: 'bg-primary/10', iconColor: 'text-primary' },
  ...
  { icon: IconGlobe, title: 'Website', info: 'orgatick.in', bg: 'bg-destructive/10', iconColor: 'text-destructive' },
];
